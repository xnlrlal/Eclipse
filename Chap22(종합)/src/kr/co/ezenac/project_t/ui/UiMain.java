package kr.co.ezenac.project_t.ui;
 ...
 *  	----
 *  	전공은 국어교육학과 컴퓨터공학 두 가지 있습니다.
 *  	국어교육학과는 국어가 필수과목이고, 컴퓨터공학은 수학이 필수과목입니다.	
 *  
 * 		이번학기에 성적이 아래와 같이 나왔습니다.
 * 				   ----	
 * 	   --------------------------------------------------------------------------------------------
...
public class UiMain {
	...
	public void createStudent() {
		Student student1 = new Student("스티브잡스", 20220915, korean, math);
		Student student2 = new Student("이순신", 20220916, math, korean);
		Student student3 = new Student("리누스토발즈", 20220917, korean, math);
		Student student4 = new Student("제임스고슬링", 20220918, korean, math);
		Student student5 = new Student("이도", 20220919, math, korean);
